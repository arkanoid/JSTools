...
class arkBaseDBClass {
     ...
     * @param (optional) dictionary Object from class arkDictionary with metadata about the table fields.
     */
...
class arkDictionary {
	...
	constructor(tableName, fields, primaryKeys, simpleList) {
		...
		fields.forEach(o => {
			let f;
			if (typeof o == 'string')
				f = arkDictionary.newField({ name: o });
			else
				f = arkDictionary.newField(o);
...
module.exports = { arkBaseDBClass, arkDictionary }
